				...
				<tbody>
                   ...
                   <c:forEach items="${listP}" var="l">
					<tr>
						...
						<td>${l.name}</td>
						<td>
						<img alt="" src="${l.image}" height="150px" width="150px">
						</td>
						<td><fmt:formatNumber maxFractionDigits="3" type="number" value="${l.price}"></fmt:formatNumber></td>
						
						
						<td>
							<a href="showEditBox?pid=${l.id}"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
							<a href="delete?did=${l.id}" ><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
						</td>
					</tr>
					</c:forEach>
